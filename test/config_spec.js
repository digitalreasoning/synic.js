...
describe("Knowledge Graph Config", function () {
    ...
    it("Test configKG, no pre-existing app", function () {
        ...
        expect(configRequest.url).toBe('http://localhost:9011/synic/api/kb/clark/config');
        ...
        expect(doConfigRequest.url).toBe('http://localhost:9011/synic/api/kb/clark/config');
    ...
    it("Test configKG, with pre-existing app", function () {
        ...
        expect(doConfigRequest.url).toBe('http://localhost:9011/synic/api/kb/clark/config/rivulet');
        doConfigRequest.respondWith({
            status: 200,
            contentType: 'application/json',
            responseText: '{}'
